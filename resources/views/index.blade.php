    ...
    <body>
        <header>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-md-7 py-4">
                            ...
                            <p class="text-muted">当サイトで紹介しているお菓子は個人的なおススメとして、コンビニなどで人気のある商品や古くから駄菓子屋で愛されているお菓子です。子供から大人まで、手軽に安価に満足いただけるラインナップです。</p>
                        </div>
            ...
            <div class="navbar navbar-dark bg-dark shadow-sm">
                <div class="container">
                    ...
                    <i class="fa fa-pie-chart" aria-hidden="true"></i><strong class="ml-2">{{ config('app.name') }}</strong>
                </a>
        ...
        <main>
            <section class="py-5 text-center container">
                <div class="row py-lg-5">
                    <div class="col-lg-6 col-md-8 mx-auto">
                        ...
                        <p class="lead text-muted">甘くて美味しいお菓子が勢揃い！チョコレートやクッキー、アイスや和菓子など、幅広いラインナップをご用意しています。どのお菓子も一口食べれば幸せな気分になれること間違いなしです。</p>
                        <form action="" method="post" novalidate class="row g-1">
                            <span class="col-4 text-left border-bottom border-gray-200"><i class="fa fa-list"></i> カテゴリ</span>
                            <label class="col-8"><input type="text" class="form-control" placeholder="カテゴリ"></label>
                            <span class="col-4 text-left border-bottom border-gray-200"><i class="fa fa-money"></i> 価格範囲</span>
                            ...
                            <span class="col-4 text-left border-bottom border-gray-200"><i class="fa fa-tags"></i> キーワード</span>
            ...
            <div class="album py-5 bg-light">
                <div class="container">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3"> @foreach ($products as $product) <div class="col">
                            <div class="card shadow-sm">
                                <img src="https://picsum.photos/id/{{ $product->category_id }}/600/320" width="100%" height="225" alt="dammyImg">
                                <div class="card-body">
                                    <h4 class="h-4 text-black-50 border-bottom border-secondary pb-3">{{ $product->name }} <span class="price">{{ $product->price }}円</span></h4>
